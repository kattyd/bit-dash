...
import './ChartCard.css'; // You'll create this to match your dark card styling

function ChartCard() {
    const { chartData, isLoading } = useBitcoinStore();

    if (isLoading || !chartData) {
        return <div className="chart-card loading">Loading chart...</div>;
    }
                    ...
                    <AreaChart data={chartData} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                        ...
                        <defs>
                            <linearGradient id="colorPrice" x1="0" y1="0" x2="0" y2="1">
                                ...
                                <stop offset="95%" stopColor="#fbc6c2" stopOpacity={0}/>
                            </linearGradient>
                        </defs>
